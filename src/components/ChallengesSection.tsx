...
export const ChallengesSection = () => {
  return (
    <div className="relative px-4 py-20">
      <div className="violet mb-10 text-center text-4xl font-semibold text-white">
        Sponsor Challenges
      </div>
      <div className="flex flex-wrap justify-evenly gap-10 py-8">
        {challengesData.map((challenge) => (
          <div key={challenge.id} className="z-10">
            <article className="hover:animate-background w-full min-w-[330px] max-w-md rounded-xl bg-gradient-to-r from-violet-500 to-violet-900 p-0.5 shadow-xl shadow-gray-700/25 transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s]">
              <div className="p-1.4 min-h-[180px] rounded-[10px] bg-gray-950/90 p-4 sm:p-6">
                ...
                <ul className="text-md violet mt-2 space-y-2 text-gray-400">
