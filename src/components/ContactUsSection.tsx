...
export const ContactUs = () => {
  return (
    <section id="ContactUs" className="min-h-screen py-10">
      <div className="my-20 bg-gradient-to-b from-indigo-500 to-indigo-200 bg-clip-text text-center text-4xl font-semibold text-transparent sm:text-5xl">
        Contact Us
      </div>
      <div className="my-8 flex flex-col items-center justify-evenly space-y-10">
        <div className="flex flex-col items-center">
          <IconMail
            className="h-14 w-14 text-indigo-500 sm:h-24 sm:w-24"
            stroke={1}
          />
          <div className="indigo text-center text-xl text-white antialiased sm:text-2xl">
            next_tech_lab@srmap.edu.in
          </div>
        </div>
        <div className="flex flex-col items-center">
          <IconBrandDiscord
            className="h-20 w-20 text-indigo-500 sm:h-24 sm:w-24"
            stroke={1}
          />
          <div className="indigo text-center text-xl text-white antialiased sm:text-2xl">
